...
Traceback (most recent call last):
  File "d:\AI City\2026��4��29�� ��Ʃ���ȹ��\_company\_agents\youtube\tools\my_videos_check.py", line 478, in <module>
    main()
    ~~~~^^
  File "d:\AI City\2026��4��29�� ��Ʃ���ȹ��\_company\_agents\youtube\tools\my_videos_check.py", line 135, in main
...
������ YouTube ���� / ä�� ���� ������
  ...
  �м� ��          : (�ڵ� ����)
Traceback (most recent call last):
  File "d:\AI City\2026��4��29�� ��Ʃ���ȹ��\_company\_agents\youtube\tools\youtube_account.py", line 46, in <module>
    main()
    ~~~~^^
  File "d:\AI City\2026��4��29�� ��Ʃ���ȹ��\_company\_agents\youtube\tools\youtube_account.py", line 40, in main
    print("\n\u26a0\ufe0f  API Ű�� ����־��. �ٸ� �������� �������� �ʽ��ϴ�.")
    ~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
