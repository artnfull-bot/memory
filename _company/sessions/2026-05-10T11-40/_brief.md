...
## 요약
현재 회사 목표와 과거 의사결정 로그를 바탕으로 가장 가치 있는 단일 작업을 결정하고 적절한 에이전트에게 분배하여 실행합니다.

## 분배
- **📱 영숙**: 회사 목표(goals.md)와 지금까지의 의사결정 로그를 검토하여 현재 가장 가치 있는 단일 작업을 결정하고, 그 작업을 적절한 에이전트에게 분배하여 실행할 계획을 수립하세요.
